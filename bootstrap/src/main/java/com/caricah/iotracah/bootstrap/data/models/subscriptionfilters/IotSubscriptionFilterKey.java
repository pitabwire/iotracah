...
/**
 * IotSubscriptionFilterKey definition.
 *
 * Code generated by Apache Ignite Schema Import utility: 02/25/2016.
 */
public class IotSubscriptionFilterKey implements Serializable {
    /** */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof IotSubscriptionFilterKey))
            return false;

        IotSubscriptionFilterKey that = (IotSubscriptionFilterKey)o;
    ...
    @Override public String toString() {
        return "IotSubscriptionFilterKey [name=" + name +

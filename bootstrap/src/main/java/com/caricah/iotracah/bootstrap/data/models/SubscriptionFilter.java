...
public class SubscriptionFilter implements IdKeyComposer, Externalizable {
    ...
    public Serializable generateIdKey() throws UnRetriableException {
        ...
        return createIdKey(getParentId(),getName());
    }

    public static String createIdKey(String parentId, String name){
    ...
    public String toString() {
        return getClass().getSimpleName() + " [ " + " partition = " + getPartition() + ", parent = " + getParentId() + ", name = " + getName() + " ]";
    }

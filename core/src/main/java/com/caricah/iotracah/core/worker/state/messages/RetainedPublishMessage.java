 ...
 */
public final class RetainedPublishMessage extends IOTMessage implements IdKeyComposer {
    ...
    public static RetainedPublishMessage from( long messageId, boolean dup, int qos, boolean retain, String topic, ByteBuffer payloadBuffer, boolean inBound) {
        ...
        RetainedPublishMessage publishMessage = new RetainedPublishMessage();

...
public class IotChannelGroupFuture extends DefaultPromise<Void> implements ChannelGroupFuture {
    ...
    private final ChannelFutureListener childListener = new ChannelFutureListener() {
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            ...
            boolean callSetDone;
            synchronized (IotChannelGroupFuture.this) {
                if (success) {
                    successCount ++;
                } else {
                    failureCount ++;
     ...
     */
    IotChannelGroupFuture(ChannelGroup group, Collection<ChannelFuture> futures,  EventExecutor executor) {
        super(executor);
        if (group == null) {
    ...
    @Override
    public IotChannelGroupFuture addListener(GenericFutureListener<? extends Future<? super Void>> listener) {
        super.addListener(listener);
        return this;
    }

    @Override
    public IotChannelGroupFuture addListeners(GenericFutureListener<? extends Future<? super Void>>... listeners) {
        super.addListeners(listeners);
        return this;
    }

    @Override
    public IotChannelGroupFuture removeListener(GenericFutureListener<? extends Future<? super Void>> listener) {
        super.removeListener(listener);
        return this;
    }

    @Override
    public IotChannelGroupFuture removeListeners(
    ...
    @Override
    public IotChannelGroupFuture await() throws InterruptedException {
        super.await();
        return this;
    }

    @Override
    public IotChannelGroupFuture awaitUninterruptibly() {
        super.awaitUninterruptibly();
        return this;
    }

    @Override
    public IotChannelGroupFuture syncUninterruptibly() {
        super.syncUninterruptibly();
        return this;
    }

    @Override
    public IotChannelGroupFuture sync() throws InterruptedException {
        super.sync();
        return this;
    }
    ...
    @Override
    public IotChannelGroupFuture setSuccess(Void result) {
    ...
    @Override
    public IotChannelGroupFuture setFailure(Throwable cause) {
        throw new IllegalStateException();
    }
